    ...
    <section>
      ...
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
        <div className="md:w-[67%] lg:w-[50%] mb-12 md:mb-6">
          <img src="https://images.unsplash.com/flagged/photo-1564767609342-620cb19b2357?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8a2V5c3xlbnwwfHwwfHx8MA%3D%3D" alt="key" 
        ...
        <div className="w-full md:w-[67%] lg:w-[40%]lg:ml-20">
          <form onSubmit={onSubmit}>
            ...
            <button 
          className="w-full bg-blue-600 text-white py-3 px-7 text-sm font-medium uppercase rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-large active:bg-blue-800" 
          type="submit">
            Sign In
          </button>
